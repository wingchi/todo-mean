...
export class TodoEffects {
  ...
  getTodos$: Observable<Action> = this.actions$
    ...
    .mergeMap(action =>
      this.http
        .get(environment.client.base_url + "/api/todos")
        .map(
          (data: Response) =>
            new TodoActions.GetTodosSuccess(data["data"]["docs"] as TodoState)
        )
  ...
  createTodo$: Observable<Action> = this.actions$
    ...
    .mergeMap(action =>
      this.http
        .post(environment.client.base_url + "/api/todos", action.payload)
        .map(
          (data: Response) =>
            new TodoActions.CreateTodoSuccess({
              ...data["data"],
              loading: false,
            })
        )
  ...
  deleteTodo$: Observable<Action> = this.actions$
    ...
    .mergeMap(action =>
      this.http
        .delete(environment.client.base_url + "/api/todos/" + action.payload._id)
        .map(
          (data: Response) =>
            new TodoActions.DeleteTodoSuccess({
              ...action.payload,
              loading: false,
            })
        )
  ...
  updateTodo$: Observable<Action> = this.actions$
    ...
    .mergeMap(action =>
      this.http
        .put(environment.client.base_url + "/api/todos", action.payload)
        .map(
          (data: Response) =>
  ...
  @Effect()
  completeTodo$: Observable<Action> = this.actions$
    .ofType<TodoActions.CompleteTodo>(TodoActions.types.COMPLETE_TODO)
    .mergeMap(action =>
      this.http
        .put(environment.client.base_url + "/api/todos", action.payload)
        .map(
